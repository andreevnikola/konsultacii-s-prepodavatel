...
export default async function DashboardPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{teacher.fullName}</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">{teacher.subject}</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
          <p className="text-sm text-gray-500 dark:text-gray-400">Active slots</p>
          <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{activeSlots}</p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{slots.length} total</p>
          <Link
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
          ...
          <p className="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1">{confirmedBookings}</p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{bookings.length} total</p>
          <Link
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Your booking link</p>
          <a
            href={bookingUrl}
            target="_blank"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 inline-block">
